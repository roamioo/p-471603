      ...
      <div className="section-container relative z-10 opacity-0 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden relative">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
            Let's Talk. Start Your <br className="hidden sm:inline" />
            <span className="text-pulse-500">Journey with Elykid Today</span>
          </h2>
          
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto">
            Your AI is already tuned into your vibe. All that's left is for you to say hey. 
            Start chatting with a companion that actually feels like it knows you.
          </p>
          ...
          <p className="text-sm text-gray-500 mt-6">
            So, what are you waiting for? The conversation's ready when you are.
          </p>
        </div>
      </div>
    </section>
